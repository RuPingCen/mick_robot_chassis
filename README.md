...
本项目描述了一个完整的单臂开源具身智能机器人开源方案，在原有移动底盘基础上集成7自由度机械臂，形成可在复杂环境中执行抓取、搬运等任务的单臂移动机器人。项目开源了小车的3D机械图，基于STM32设计的小车控制板，电源板（为传感器供电）；小车的**PCB**、**代码**及**3D图纸**均是开源，大家可以自行下载打样学习。
...
- **ROS_Node**：参考 [mick_robot](https://github.com/RuPingCen/mick_robot) 仓库（https://github.com/RuPingCen/mick_robot）
...
#### 🤖 机器人系统能力
1、同时支持ROS2和DORA机器人中间件

2、集成室内导航与VLLM大语言模型，实现语义理解下的自主抓取任务

3、底盘移动与机械臂操作深度融合，支持动态环境下的协同控制

![image-20240411174345904](README.assets/zhuaqudemo.gif)

#### 🚗 自主导航能力
1、支持autoware开源导航框架

2、支持基于ROS2 move_base导航(gmapping、cartographer)

3、支持大规模点云地图构建与优化、3D导航
...
小车面板上以太网调试口IP地址固定为“192.168.0.7”，将网线连接面板调试口与电脑，配置电脑IP地址为“192.168.0.201”。利用github仓库目录下“Reference_Documents/02_调试工具/网络_串口调试工具.exe”工具，将调试工具默认端口设置为8234，串口波特率为921600，工作模式设置为TCP服务端，即可打印小车调试信息。
